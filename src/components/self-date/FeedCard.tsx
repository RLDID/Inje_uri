      ...
      <div className="mt-3">
        {hasSingleContentImage ? (
          <div className="flex gap-3">
            <p data-clarity-mask className="line-clamp-4 min-w-0 flex-1 whitespace-pre-wrap break-words text-[14px] leading-6 text-[var(--color-text-primary)]">
              {content.text}
            </p>
          ...
          <p data-clarity-mask className="line-clamp-3 whitespace-pre-wrap break-words text-[14px] leading-6 text-[var(--color-text-primary)]">
            {content.text}
          </p>
        )}
